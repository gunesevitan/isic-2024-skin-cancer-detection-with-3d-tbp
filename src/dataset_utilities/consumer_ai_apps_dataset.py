...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'consumer-ai-apps'
    ...
    df_metadata['id'] = pd.Series(df_metadata.index).apply(lambda x: f'consumer-ai-apps_{x}')
    df_metadata['dataset'] = 'consumer-ai-apps'
    ...
    df_metadata.to_parquet(output_directory / 'consumer-ai-apps-metadata.parquet')
    settings.logger.info(f'consumer-ai-apps-metadata.parquet is saved to {output_directory}')
