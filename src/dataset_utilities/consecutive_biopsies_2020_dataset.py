...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'consecutive-biopsies-2020'
    ...
    df_metadata['id'] = pd.Series(df_metadata.index).apply(lambda x: f'consecutive-biopsies-2020_{x}')
    df_metadata['dataset'] = 'consecutive-biopsies-2020'
    ...
    df_metadata.to_parquet(output_directory / 'consecutive-biopsies-2020-metadata.parquet')
    settings.logger.info(f'consecutive-biopsies-2020-metadata.parquet is saved to {output_directory}')
