...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'bcn20000'
    ...
    df_metadata['id'] = pd.Series(df_metadata.index).apply(lambda x: f'bcn20000_{x}')
    df_metadata['dataset'] = 'bcn20000'
    ...
    df_metadata.to_parquet(output_directory / 'bcn20000-metadata.parquet')
    settings.logger.info(f'bcn20000-metadata.parquet is saved to {output_directory}')
