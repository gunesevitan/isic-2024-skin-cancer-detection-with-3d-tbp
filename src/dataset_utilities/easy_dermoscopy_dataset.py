...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'easy-dermoscopy-expert-agreement-study'
    ...
    df_metadata['id'] = pd.Series(df_metadata.index).apply(lambda x: f'easy-dermoscopy-expert-agreement-study_{x}')
    df_metadata['dataset'] = 'easy-dermoscopy-expert-agreement-study'
    ...
    df_metadata.to_parquet(output_directory / 'easy-dermoscopy-expert-agreement-study-metadata.parquet')
    settings.logger.info(f'easy-dermoscopy-expert-agreement-study-metadata.parquet is saved to {output_directory}')
