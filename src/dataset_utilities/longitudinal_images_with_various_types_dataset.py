...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'longitudinal-images-with-various-types'
    ...
    df_metadata['id'] = pd.Series(df_metadata.index).apply(lambda x: f'longitudinal-images-with-various-types_{x}')
    df_metadata['dataset'] = 'longitudinal-images-with-various-types'
    ...
    df_metadata.to_parquet(output_directory / 'longitudinal-images-with-various-types-metadata.parquet')
    settings.logger.info(f'longitudinal-images-with-various-types-metadata is saved to {output_directory}')
