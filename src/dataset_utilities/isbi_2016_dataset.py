...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'isbi-2016'
    ...
    df_metadata['id'] = pd.Series(df_metadata.index).apply(lambda x: f'isbi-2016_{x}')
    df_metadata['dataset'] = 'isbi-2016'
    ...
    df_metadata.to_parquet(output_directory / 'isbi-2016-metadata.parquet')
    settings.logger.info(f'isbi-2016-metadata.parquet is saved to {output_directory}')
