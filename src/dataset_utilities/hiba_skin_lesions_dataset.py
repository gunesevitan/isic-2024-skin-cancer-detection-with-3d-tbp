...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'hiba-skin-lesions'
    ...
    df_metadata['id'] = pd.Series(df_metadata.index).apply(lambda x: f'hiba-skin-lesions_{x}')
    df_metadata['dataset'] = 'hiba-skin-lesions'
    ...
    df_metadata.to_parquet(output_directory / 'hiba-skin-lesions-metadata.parquet')
    settings.logger.info(f'hiba-skin-lesions-metadata.parquet is saved to {output_directory}')
