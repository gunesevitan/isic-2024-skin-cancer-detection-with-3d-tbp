...
if __name__ == '__main__':
    ...
    dataset_directory = settings.DATA / 'ham10000'
    ...
    df_metadata['id'] = pd.Series(df_metadata.index).apply(lambda x: f'ham10000_{x}')
    df_metadata['dataset'] = 'ham10000'
    ...
    df_metadata.to_parquet(output_directory / 'ham10000-metadata.parquet')
    settings.logger.info(f'ham10000-metadata.parquet is saved to {output_directory}')
